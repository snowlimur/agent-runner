...
4. **Double Check** Always run `golangci-lint run` before considering code complete.
...
2. Follow the TTD Cycle.
3. Mark ONLY this completed task as done in `implementation-plan.md` (`[X] `).
4. Check `implementation-plan.md` for remaining unchecked tasks in the Active Phase.
